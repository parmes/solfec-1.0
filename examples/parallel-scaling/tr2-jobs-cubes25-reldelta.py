...
lmxi = [3, 5, 10, 15, 20, 30, 50]
nsdl = [0.0, 0.00001, 0.0001, 0.001, 0.01, 0.025, 0.05]
kifo = ['BC', 'RG']
lepsC = [0.25, 0.1, 0.05, 0.025, 0.01, 0.25, 0.1, 0.05, 0.025, 0.01, 0.25, 0.1, 0.05, 0.025, 0.01]
lmxiC = [  10,  10,   10,    10,   10,   15,  15,   15,    15,   15,   20,  20,   20,    20,   20]
jobs = []
