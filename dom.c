...
static void pack_stats (DOM *dom, int rank, int *dsize, double **d, int *doubles, int *isize, int **i, int *ints)
{
  ...
  pack_int (isize, i, ints, dom->megabytes);
...
static void update_external_constraint_points (DOM *dom)
{
  ...
  dom->megabytes += COMALL (MPI_COMM_WORLD, send, nsend, &recv, &nrecv)/1000000;
...
static void update_children (DOM *dom)
{
  ...
  dom->megabytes += COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)update_children_pack, dom, (OBJ_Unpack)update_children_unpack, send, dom->ncpu, &recv, &nrecv)/1000000;
...
static void domain_balancing (DOM *dom)
{
  ...
  /* communication */
  dom->megabytes += COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)domain_balancing_pack, dom, (OBJ_Unpack)domain_balancing_unpack, send, dom->ncpu, &recv, &nrecv)/1000000;
  ...
  dom->megabytes += COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)old_boundary_constraints_pack, dom, (OBJ_Unpack)old_external_constraints_unpack, send, dom->ncpu, &recv, &nrecv)/1000000;
...
static void domain_gluing_begin (DOM *dom)
{
  ...
  /* communication */
  dom->megabytes += COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)domain_gluing_begin_pack, dom, (OBJ_Unpack)domain_gluing_begin_unpack, send, dom->ncpu, &recv, &nrecv)/1000000;
...
static void domain_gluing_end (DOM *dom)
{
  ...
  dom->megabytes += COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)domain_gluing_end_pack, dom, (OBJ_Unpack)domain_gluing_end_unpack, send, dom->ncpu, &recv, &nrecv)/1000000;
...
static void manage_bodies (DOM *dom)
{
  ...
  dom->megabytes = COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)manage_bodies_pack, dom, (OBJ_Unpack)manage_bodies_unpack, send, dom->ncpu, &recv, &nrecv)/1000000;
...
void update_external_RUV (DOM *dom)
{
  ...
  dom->megabytes += COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)pack_RUV, dom,
...
void DOM_Update_External_Reactions (DOM *dom, short normal)
{
  ...
  if (normal > 0)
  {
    dom->megabytes += COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)pack_normal_reactions, dom,
      (OBJ_Unpack)unpack_normal_reactions, send, dom->ncpu, &recv, &nrecv)/1000000;
  }
  else
  {
    dom->megabytes += COMOBJSALL (MPI_COMM_WORLD, (OBJ_Pack)pack_reactions, dom,
