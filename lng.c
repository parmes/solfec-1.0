...
#define METHOD_WITH_KEYWORDS(func) (PyCFunction)(void *)(PyCFunctionWithKeywords)(func)
...
static int is_solver (PyObject *obj, char *var); /* is it a solfec solver ? */
static int get_solver_kind (PyObject *obj); /* what kind of solver is that ? */
static void* get_solver (PyObject *obj); /* return solver interface */
...
static int is_dict (PyObject *obj, char *var)
{
  if (obj)
  {
    ...
    {
      char buf [BUFLEN];
      sprintf (buf, "'%s' must be a dictionary object", var);
      PyErr_SetString (PyExc_TypeError, buf);
      return 0;
    }
  }
...
{
  {"vertex", METHOD_WITH_KEYWORDS(lng_CONVEX_vertex), METH_VARARGS|METH_KEYWORDS, "Return a vertex point of a convex"},
  {NULL, NULL, 0, NULL}
};
...
/* return lists of nodes of inter-element faces */
static PyObject* lng_MESH_inter_element_faces (lng_MESH *self, PyObject *args, PyObject *kwds)
{
  ...
  MESH_Inter_Element_Faces (self->msh, &faces, &nfaces);
...
{ 
  {"node", METHOD_WITH_KEYWORDS(lng_MESH_node), METH_VARARGS|METH_KEYWORDS, "Return a node point of a mesh"},
  {"nodes_on_surface", METHOD_WITH_KEYWORDS(lng_MESH_nodes_on_surface), METH_VARARGS|METH_KEYWORDS, "Return list of node numbers belonging to a given surface"},
  {"inter_element_faces", METHOD_WITH_KEYWORDS(lng_MESH_inter_element_faces), METH_NOARGS, "Return list of node lists of inter-element faces"},
  {"inter_element_faces_on_plane", METHOD_WITH_KEYWORDS(lng_MESH_inter_element_faces_on_plane), METH_VARARGS|METH_KEYWORDS, "Return list of node lists of inter-element faces on a plane"},
  {"get_data", METHOD_WITH_KEYWORDS(lng_MESH_get_meshdata), METH_NOARGS, "Return mesh data - very developmental!"},
  {"set_volid", METHOD_WITH_KEYWORDS(lng_MESH_setvolid), METH_VARARGS|METH_KEYWORDS, "Set volid for all faces"},
  {"surface_integration_points", METHOD_WITH_KEYWORDS(lng_MESH_surface_integration_points), METH_VARARGS|METH_KEYWORDS, "Return surface integration points"},
  {"volume_integration_points", METHOD_WITH_KEYWORDS(lng_MESH_volume_integration_points), METH_VARARGS|METH_KEYWORDS, "Return volume integration points"},
  {NULL, NULL, 0, NULL}
};
...
static PyObject* lng_TETRAHEDRALIZE (PyObject *self, PyObject *args, PyObject *kwds)
{
  ...
  if (out)
  {
    ...
    PARSEKEYS ("OO|ddiiddd", &shape, &path, &volume, &quality, &volid, &surfid);
...
/* apply bulk material */
static PyObject* lng_APPLY_BULKMAT (PyObject *self, PyObject *args, PyObject *kwds)
{
...
static PyObject* lng_CONTACT_SPARSIFY (PyObject *self, PyObject *args, PyObject *kwds)
{
  ...
  PARSEKEYS ("O|ddd", &solfec, &threshold, &minarea, &mindist);
...
{
  {"HULL", METHOD_WITH_KEYWORDS(lng_HULL), METH_VARARGS|METH_KEYWORDS, "Create convex hull from a point set"},
  {"MESH2CONVEX", METHOD_WITH_KEYWORDS(lng_MESH2CONVEX), METH_VARARGS|METH_KEYWORDS, "Create list of CONVEX objects from a MESH object"},
  {"HEX", METHOD_WITH_KEYWORDS(lng_HEX), METH_VARARGS|METH_KEYWORDS, "Create mesh of a hexahedral shape"},
  {"TETRAHEDRALIZE", METHOD_WITH_KEYWORDS(lng_TETRAHEDRALIZE), METH_VARARGS|METH_KEYWORDS, "Generate tetrahedral mesh"},
  {"PIPE", METHOD_WITH_KEYWORDS(lng_PIPE), METH_VARARGS|METH_KEYWORDS, "Create mesh of a pipe shape"},
  {"ELLIP_MESH", METHOD_WITH_KEYWORDS(lng_ELLIP_MESH), METH_VARARGS|METH_KEYWORDS, "Create tetrahedral ellipsoid mesh"},
  {"ROUGH_HEX", METHOD_WITH_KEYWORDS(lng_ROUGH_HEX), METH_VARARGS|METH_KEYWORDS, "Create a rough hexahedral mesh containing a given shape"},
  ...
  {"FORCE", METHOD_WITH_KEYWORDS(lng_FORCE), METH_VARARGS|METH_KEYWORDS, "Apply point force"},
  {"TORQUE", METHOD_WITH_KEYWORDS(lng_TORQUE), METH_VARARGS|METH_KEYWORDS, "Apply point torque"},
  {"PRESSURE", METHOD_WITH_KEYWORDS(lng_PRESSURE), METH_VARARGS|METH_KEYWORDS, "Apply pressure"},
  {"SIMPLIFIED_CRACK", METHOD_WITH_KEYWORDS(lng_SIMPLIFIED_CRACK), METH_VARARGS|METH_KEYWORDS, "Prescribe crack"},
  {"IMBALANCE_TOLERANCE", METHOD_WITH_KEYWORDS(lng_IMBALANCE_TOLERANCE), METH_VARARGS|METH_KEYWORDS, "Adjust parallel imbalance tolerance"},
  {"RANK", METHOD_WITH_KEYWORDS(lng_RANK), METH_NOARGS, "Get current processor rank"},
  {"BARRIER", METHOD_WITH_KEYWORDS(lng_BARRIER), METH_NOARGS, "Set up parallel barrier"},
  {"NCPU", METHOD_WITH_KEYWORDS(lng_NCPU), METH_VARARGS|METH_KEYWORDS, "Get the number of processors"},
  {"HERE", METHOD_WITH_KEYWORDS(lng_HERE), METH_VARARGS|METH_KEYWORDS, "Test whether an object is located on the current processor"},
  {"VIEWER", METHOD_WITH_KEYWORDS(lng_VIEWER), METH_NOARGS, "Test whether the viewer is enabled"},
  {"SUBDIR", METHOD_WITH_KEYWORDS(lng_SUBDIR), METH_NOARGS, "Return the optional output subdirectory"},
  {"BODY_CHARS", METHOD_WITH_KEYWORDS(lng_BODY_CHARS), METH_VARARGS|METH_KEYWORDS, "Overwrite body characteristics"},
  {"INITIAL_VELOCITY", METHOD_WITH_KEYWORDS(lng_INITIAL_VELOCITY), METH_VARARGS|METH_KEYWORDS, "Apply initial velocity"},
  {"APPLY_BULKMAT", METHOD_WITH_KEYWORDS(lng_APPLY_BULKMAT), METH_VARARGS|METH_KEYWORDS, "Apply bulk material"},
  {"DELETE", METHOD_WITH_KEYWORDS(lng_DELETE), METH_VARARGS|METH_KEYWORDS, "Delete a body or a constraint"},
  {"SCALE", METHOD_WITH_KEYWORDS(lng_SCALE), METH_VARARGS|METH_KEYWORDS, "Scale shape"},
  {"TRANSLATE", METHOD_WITH_KEYWORDS(lng_TRANSLATE), METH_VARARGS|METH_KEYWORDS, "Translate shape"},
  {"ROTATE", METHOD_WITH_KEYWORDS(lng_ROTATE), METH_VARARGS|METH_KEYWORDS, "Rotate shape"},
  {"SPLIT", METHOD_WITH_KEYWORDS(lng_SPLIT), METH_VARARGS|METH_KEYWORDS, "Split shape by plane"},
  {"MESH_SPLIT", METHOD_WITH_KEYWORDS(lng_MESH_SPLIT), METH_VARARGS|METH_KEYWORDS, "Split mesh by node set"},
  {"RT_SPLIT", METHOD_WITH_KEYWORDS(lng_RT_SPLIT), METH_VARARGS|METH_KEYWORDS, "Real-time meshed body split"},
  {"COPY", METHOD_WITH_KEYWORDS(lng_COPY), METH_VARARGS|METH_KEYWORDS, "Copy shape"},
  {"BEND", METHOD_WITH_KEYWORDS(lng_BEND), METH_VARARGS|METH_KEYWORDS, "Bend shape"},
  {"BYLABEL", METHOD_WITH_KEYWORDS(lng_BYLABEL), METH_VARARGS|METH_KEYWORDS, "Get object by label"},
  {"MASS_CENTER", METHOD_WITH_KEYWORDS(lng_MASS_CENTER), METH_VARARGS|METH_KEYWORDS, "Get mass center"},
  {"CONTACT_EXCLUDE_BODIES", METHOD_WITH_KEYWORDS(lng_CONTACT_EXCLUDE_BODIES), METH_VARARGS|METH_KEYWORDS, "Exclude body pair from contact detection"},
  {"CONTACT_EXCLUDE_SURFACES", METHOD_WITH_KEYWORDS(lng_CONTACT_EXCLUDE_SURFACES), METH_VARARGS|METH_KEYWORDS, "Exclude surface pair from contact detection"},
  {"CONTACT_SPARSIFY", METHOD_WITH_KEYWORDS(lng_CONTACT_SPARSIFY), METH_VARARGS|METH_KEYWORDS, "Adjust contact sparsification"},
  {"RUN", METHOD_WITH_KEYWORDS(lng_RUN), METH_VARARGS|METH_KEYWORDS, "Run analysis"},
  {"OUTPUT", METHOD_WITH_KEYWORDS(lng_OUTPUT), METH_VARARGS|METH_KEYWORDS, "Set data output interval"},
  {"EXTENTS", METHOD_WITH_KEYWORDS(lng_EXTENTS), METH_VARARGS|METH_KEYWORDS, "Set scene extents"},
  {"REGISTER_CALLBACK", METHOD_WITH_KEYWORDS(lng_REGISTER_CALLBACK), METH_VARARGS|METH_KEYWORDS, "Register callback and data pair"},
  {"CALLBACK", METHOD_WITH_KEYWORDS(lng_CALLBACK), METH_VARARGS|METH_KEYWORDS, "Set analysis callback"},
  {"UNPHYSICAL_PENETRATION", METHOD_WITH_KEYWORDS(lng_UNPHYSICAL_PENETRATION), METH_VARARGS|METH_KEYWORDS, "Set unphysical penetration bound"},
  {"GEOMETRIC_EPSILON", METHOD_WITH_KEYWORDS(lng_GEOMETRIC_EPSILON), METH_VARARGS|METH_KEYWORDS, "Set geometric epsilon"},
  {"WARNINGS", METHOD_WITH_KEYWORDS(lng_WARNINGS), METH_VARARGS|METH_KEYWORDS, "Enable or disable warnings"},
  {"INITIALIZE_STATE", METHOD_WITH_KEYWORDS(lng_INITIALIZE_STATE), METH_VARARGS|METH_KEYWORDS, "Initialize Solfec state"},
  {"RIGID_TO_FEM", METHOD_WITH_KEYWORDS(lng_RIGID_TO_FEM), METH_VARARGS|METH_KEYWORDS, "Map rigid motion onto FEM bodies"},
  {"LOCDYN_DUMP", METHOD_WITH_KEYWORDS(lng_LOCDYN_DUMP), METH_VARARGS|METH_KEYWORDS, "Dump local dynamics"},
  {"OVERLAPPING", METHOD_WITH_KEYWORDS(lng_OVERLAPPING), METH_VARARGS|METH_KEYWORDS, "Detect shapes (not) overlapping obstacles"},
  {"MBFCP_EXPORT", METHOD_WITH_KEYWORDS(lng_MBFCP_EXPORT), METH_VARARGS|METH_KEYWORDS, "Export MBFCP definition"},
  {"NON_SOLFEC_ARGV", METHOD_WITH_KEYWORDS(lng_NON_SOLFEC_ARGV), METH_NOARGS, "Return non-Solfec input arguments"},
  {"MODAL_ANALYSIS", METHOD_WITH_KEYWORDS(lng_MODAL_ANALYSIS), METH_VARARGS|METH_KEYWORDS, "Perform modal analysis of a FEM body"},
  {"BODY_MM_EXPORT", METHOD_WITH_KEYWORDS(lng_BODY_MM_EXPORT), METH_VARARGS|METH_KEYWORDS, "Export MatrixMarket M and K matrices of a FEM body"},
  {"DISPLAY_POINT", METHOD_WITH_KEYWORDS(lng_DISPLAY_POINT), METH_VARARGS|METH_KEYWORDS, "Add display point"},
  {"FRACTURE_EXPORT_YAFFEMS", METHOD_WITH_KEYWORDS(lng_FRACTURE_EXPORT_YAFFEMS), METH_VARARGS|METH_KEYWORDS, "Export fracture data to Yaffems"},
  {"DURATION", METHOD_WITH_KEYWORDS(lng_DURATION), METH_VARARGS|METH_KEYWORDS, "Get analysis duration"},
  {"RENDER", METHOD_WITH_KEYWORDS(lng_RENDER), METH_VARARGS|METH_KEYWORDS, "Render bodies"},
  {"XDMF_EXPORT", METHOD_WITH_KEYWORDS(lng_XDMF_EXPORT), METH_VARARGS|METH_KEYWORDS, "Export results in XDMF format"},
  {"SOLFEC_EXPORT", METHOD_WITH_KEYWORDS(lng_SOLFEC_EXPORT), METH_VARARGS|METH_KEYWORDS, "Export results in native format"},
  {"REGISTER_BASE", METHOD_WITH_KEYWORDS(lng_REGISTER_BASE), METH_VARARGS|METH_KEYWORDS, "Register FE base"},
  {"COROTATED_DISPLACEMENTS", METHOD_WITH_KEYWORDS(lng_COROTATED_DISPLACEMENTS), METH_VARARGS|METH_KEYWORDS, "Extract snapshots of co-rotated FEM displacements"},
  {"RIGID_DISPLACEMENTS", METHOD_WITH_KEYWORDS(lng_RIGID_DISPLACEMENTS), METH_VARARGS|METH_KEYWORDS, "Output six rigid body displacements of a FEM body"},
  {"FORWARD", METHOD_WITH_KEYWORDS(lng_FORWARD), METH_VARARGS|METH_KEYWORDS, "Set forward in READ mode"},
  {"BACKWARD", METHOD_WITH_KEYWORDS(lng_BACKWARD), METH_VARARGS|METH_KEYWORDS, "Set backward in READ mode"},
  {"SEEK", METHOD_WITH_KEYWORDS(lng_SEEK), METH_VARARGS|METH_KEYWORDS, "Seek to time in READ mode"},
  {"DISPLACEMENT", METHOD_WITH_KEYWORDS(lng_DISPLACEMENT), METH_VARARGS|METH_KEYWORDS, "Get displacement of a referential point"},
  {"VELOCITY", METHOD_WITH_KEYWORDS(lng_VELOCITY), METH_VARARGS|METH_KEYWORDS, "Get velocity of a referential point"},
  {"STRESS", METHOD_WITH_KEYWORDS(lng_STRESS), METH_VARARGS|METH_KEYWORDS, "Get stress of a referential point"},
  {"ENERGY", METHOD_WITH_KEYWORDS(lng_ENERGY), METH_VARARGS|METH_KEYWORDS, "Get energy"},
  {"TIMING", METHOD_WITH_KEYWORDS(lng_TIMING), METH_VARARGS|METH_KEYWORDS, "Get timing"},
  {"HISTORY", METHOD_WITH_KEYWORDS(lng_HISTORY), METH_VARARGS|METH_KEYWORDS, "Get history of entites"},
  {NULL, 0, 0, NULL}
};
