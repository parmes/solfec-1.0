...
# 16 Feb 2016
# -----------
# case 1: many meshes created and assigned on all ranks
# result: uniform use of memory on all ranks (approx 300 MB)

step = 1E-3

solfec = SOLFEC ('DYNAMIC', step, 'out/devel/memrank0case1')
