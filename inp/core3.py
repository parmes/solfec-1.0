# simple implicit core model with acceleration
...
surfmat = SURFACE_MATERIAL (solfec, model = 'SIGNORINI_COULOMB', friction = 0.7)
...
gs.variant = 'SIMPLIFIED'

OUTPUT (solfec, 0.0, compression='FASTLZ')
