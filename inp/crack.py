...
for i in range (0, nsid):
  for j in range (0, nsid):
    ...
    SIMPLIFIED_CRACK (bod, bod.center, (1, 0, 0), 3, 'TENSILE', 1E5, 10)
    SIMPLIFIED_CRACK (bod, bod.center, (0, 1, 0), 3, 'TENSILE', 1E5, 10)
    SIMPLIFIED_CRACK (bod, bod.center, (0, 0, 1), 3, 'TENSILE', 1E5, 10)
