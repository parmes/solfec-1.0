  ...
  for k in range (N_LAYERS):
	...
	if kinem_kind == 'FINITE_ELEMENT' or kinem_kind == 'PSEUDO_RIGID' and enable_cracks:
	  if counter % 2 == 0:
	    ...
	    dir2 = (1, 0, 0)
	  if HERE (solfec, bod):
	    SIMPLIFIED_CRACK (bod, TRANSLATE (bod.center, tra1), dir1, (3, 3), 'TENSILE', ft=1E3, topoadj = 'OFF')
	    SIMPLIFIED_CRACK (bod, TRANSLATE (bod.center, tra2), dir2, (3, 3), 'TENSILE', ft=1E3, topoadj = 'ON')
	  counter = counter + 1
